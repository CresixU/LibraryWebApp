...
namespace LibraryAPI.Application.Application.Services
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<string> GenerateJwt(LoginUserDTO dto)
        {
            ...
            {
                new Claim(ClaimTypes.NameIdentifier, user.Id.ToString(), "string"),
                new Claim(ClaimTypes.Name, $"{user.Firstname} {user.Lastname}"),
                new Claim(ClaimTypes.Email,$"{user.Email}"),
                new Claim(ClaimTypes.Role, $"{user.Role.Name}"),
                new Claim("City", user.Address.City, "string"),
                new Claim("RoleName", user.Role.Name, "string")
            };
